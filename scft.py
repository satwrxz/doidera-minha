...
def build_level(level_id=1, difficulty=1.0):
    ...
    if level_id == 1:
        ...
        # Conteúdo expandido (x > 2700)
        platforms.append(Platform(2960, 520, 200, 24, 2))
        ...
        platforms.append(Platform(3650, 550, 300, 40, 0))
    ...
    # ── LEVEL 2: Plataformas — corrigido, sem espinhos duplos ─
        ...
        # Conteúdo expandido (x > 2700)
        platforms.append(Platform(3360, 520, 200, 24, 2))
        m_plats.append(MovingPlatform(3600, 500, 140, 22, 0, -200))
        platforms.append(Platform(3800, 580, 400, 40, 0))
        enemies.append(Enemy(3900, 540, 100, hp(4)))
        enemies.append(ShootingEnemy(4100, 540, 80, hp(3)))
        platforms.append(Platform(4200, 590, 300, 40, 1))
    ...
    # ── LEVEL 3: Puzzles — switches, portões, espinhos alternados ─
        ...
        platforms.append(Platform(500, 560, 300, 30, 1))
        ...
        # Conteúdo expandido (x > 2700)
        platforms.append(Platform(3560, 520, 200, 24, 2))
        platforms.append(Platform(3800, 580, 400, 40, 0))
        enemies.append(Enemy(3900, 540, 120, hp(4)))
        enemies.append(FlyingEnemy(4050, 460, hp(3), float_height=400))
        platforms.append(Platform(4300, 570, 400, 40, 1))
    ...
    # ── LEVEL 4: A Ascensão — desafio de pulo vertical ───────
        ...
        # Conteúdo expandido (x > 2700)
        platforms.append(Platform(4060, 500, 200, 24, 2))
        platforms.append(Platform(4300, 550, 600, 40, 0))
        enemies.append(Enemy(4400, 510, 120, hp(5)))
        enemies.append(ShootingEnemy(4600, 510, 100, hp(4)))
        platforms.append(Platform(4950, 540, 200, 24, 1))
...
class Game:
    ...
    def update(self):
        ...
        # Portão do boss abre se o boss estiver morto
        boss_dead = self.hud.boss_ref is not None and self.hud.boss_ref.state == getattr(Enemy, 'DEAD', 'dead')
