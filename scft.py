...
class Enemy:
    ...
    def update(self, platforms, player_rect):
        ...
        # Borda de plataforma: pula se em chase/attack, vira se patrol
...
def build_level(level_id=1, difficulty=1.0):
    ...
    if level_id == 1:
        ...
        platforms.append(Platform(3500, 540, 400, 40, 0))
    ...
    # ── LEVEL 2: Plataformas — corrigido, sem espinhos duplos ─
        ...
        platforms.append(Platform(3400, 560, 300, 40, 1))
        platforms.append(Platform(3800, 520, 300, 40, 2))
    ...
    # ── LEVEL 3: Puzzles — switches, portões, espinhos alternados ─
        ...
        platforms.append(Platform(4100, 540, 300, 40, 0))
        platforms.append(Platform(4500, 560, 250, 40, 2))
    ...
    # ── LEVEL 4: A Ascensão — desafio de pulo vertical ───────
        ...
        platforms.append(Platform(4500, 480, 300, 30, 0))
        platforms.append(Platform(4900, 540, 250, 30, 2))
    ...
    # ── LEVEL 5: O Boss Final — arena corrigida ───────────────
        ...
        # Goal após o boss
        platforms.append(Platform(3600, 560, 400, 45, 0))
