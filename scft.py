...
class Enemy:
    ...
    def update(self, platforms, player_rect):
        ...
        # Borda de plataforma: pula se agressivo, senão vira
...
def build_level(level_id=1, difficulty=1.0):
    ...
    if level_id == 1:
        ...
        platforms.append(Platform(3000, 520, 300, 30, 2))
        platforms.append(Platform(3400, 580, 400, 40, 0))
        enemies.append(Enemy(3100, 480, 80, hp(4)))
        enemies.append(FlyingEnemy(3500, 500, hp(2), float_height=420))
        enemies.append(Enemy(3650, 540, 100, hp(4)))

        checkpoints.append(Checkpoint(3000, 486))
        orbs.append(HealthOrb(3100, 440))

        goal = LevelGoal(3850, 504)
    ...
    # ── LEVEL 2: Plataformas — corrigido, sem espinhos duplos ─
        ...
        m_plats.append(MovingPlatform(3400, 540, 150, 22, 300, 0))
        platforms.append(Platform(3800, 560, 400, 40, 0))
        platforms.append(Platform(4250, 520, 200, 30, 2))
        enemies.append(Enemy(3850, 520, 120, hp(4)))
        enemies.append(ShootingEnemy(4000, 520, 100, hp(3)))
        enemies.append(FlyingEnemy(4300, 440, hp(3), float_height=380))

        orbs.append(HealthOrb(3900, 480))
        checkpoints.append(Checkpoint(3800, 516))
        goal = LevelGoal(4350, 444)
    ...
    # ── LEVEL 3: Puzzles — switches, portões, espinhos alternados ─
        ...
        platforms.append(Platform(3600, 540, 250, 30, 2, hazard=True, hazard_timed=True, hazard_offset=30))
        platforms.append(Platform(3900, 600, 400, 40, 0))
        m_plats.append(MovingPlatform(4350, 560, 150, 22, 0, -200))
        platforms.append(Platform(4550, 400, 200, 30, 1))

        enemies.append(Enemy(3950, 560, 100, hp(4)))
        enemies.append(ShootingEnemy(4100, 560, 80, hp(4)))
        enemies.append(FlyingEnemy(4400, 320, hp(3), float_height=260))

        orbs.append(HealthOrb(4000, 520))
        checkpoints.append(Checkpoint(3950, 556))
        goal = LevelGoal(4650, 324)
    ...
    # ── LEVEL 4: A Ascensão — desafio de pulo vertical ───────
        ...
        platforms.append(Platform(4000, 480, 250, 30, 2))
        m_plats.append(MovingPlatform(4300, 440, 150, 22, 250, 0))
        platforms.append(Platform(4650, 400, 400, 40, 0))
        enemies.append(Enemy(4700, 360, 150, hp(5)))
        enemies.append(ShootingEnemy(4850, 360, 120, hp(4)))
        enemies.append(FlyingEnemy(5000, 280, hp(3), float_height=200))

        checkpoints.append(Checkpoint(4700, 326))
        orbs.append(HealthOrb(4800, 320))
