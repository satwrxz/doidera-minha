...
def build_level(level_id=1, difficulty=1.0):
    ...
    if level_id == 1:
        ...
        # Expansão Level 1 (x > 2700)
        platforms.append(Platform(3000, 600, 400, 40, 0))
        platforms.append(Platform(3500, 540, 200, 24, 2))
        enemies.append(Enemy(3200, 560, 80, hp(4)))
    ...
    # ── LEVEL 2: Plataformas — corrigido, sem espinhos duplos ─
        ...
        # Expansão Level 2 (x > 3200)
        platforms.append(Platform(3500, 580, 400, 40, 1))
        platforms.append(Platform(4000, 520, 200, 24, 2))
        enemies.append(ShootingEnemy(3700, 540, 80, hp(3)))
        enemies.append(Enemy(4100, 480, 60, hp(4)))
    ...
    # ── LEVEL 3: Puzzles — switches, portões, espinhos alternados ─
        ...
        # Expansão Level 3 (x > 3400)
        platforms.append(Platform(3700, 600, 400, 40, 0))
        platforms.append(Platform(4200, 540, 300, 30, 2))
        enemies.append(Enemy(3800, 560, 80, hp(5)))
        enemies.append(ShootingEnemy(4300, 500, 80, hp(4)))
    ...
    # ── LEVEL 4: A Ascensão — desafio de pulo vertical ───────
        ...
        # Expansão Level 4 (x > 3800)
        platforms.append(Platform(4100, 550, 400, 40, 0))
        platforms.append(Platform(4600, 480, 300, 30, 2))
        enemies.append(Enemy(4200, 510, 100, hp(5)))
        enemies.append(FlyingEnemy(4400, 400, hp(3), float_height=320))
        enemies.append(ShootingEnemy(4700, 440, 80, hp(4)))
