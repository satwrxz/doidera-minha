...
def build_level(level_id=1, difficulty=1.0):
    ...
    if level_id == 1:
        ...
        # Expansão v2.0
        platforms.append(Platform(3100, 540, 300, 24, 2))
        platforms.append(Platform(3500, 500, 400, 40, 0))
        enemies.append(Enemy(3200, 500, 80, hp(3)))
        enemies.append(Enemy(3600, 460, 80, hp(4)))
        enemies.append(FlyingEnemy(3700, 400, hp(2), float_height=340))
    ...
    # ── LEVEL 2: Plataformas — corrigido, sem espinhos duplos ─
        ...
        # Expansão v2.0
        platforms.append(Platform(3450, 520, 250, 24, 1))
        m_plats.append(MovingPlatform(3750, 500, 150, 22, 200, 0))
        platforms.append(Platform(4000, 540, 400, 40, 0))
        enemies.append(Enemy(3550, 480, 80, hp(4)))
        enemies.append(ShootingEnemy(4100, 500, 80, hp(3)))
        enemies.append(Enemy(4250, 500, 100, hp(4)))
    ...
    # ── LEVEL 3: Puzzles — switches, portões, espinhos alternados ─
        ...
        # Expansão v2.0
        platforms.append(Platform(3650, 580, 300, 30, 2))
        platforms.append(Platform(4000, 520, 200, 28, 1, hazard=True, hazard_timed=True, hazard_offset=30))
        platforms.append(Platform(4250, 560, 450, 40, 0))
        enemies.append(Enemy(3750, 540, 80, hp(4)))
        enemies.append(FlyingEnemy(4400, 450, hp(3), float_height=380))
        enemies.append(ShootingEnemy(4500, 520, 80, hp(4)))
    ...
    # ── LEVEL 4: A Ascensão — desafio de pulo vertical ───────
        ...
        # Expansão v2.0
        platforms.append(Platform(4100, 500, 300, 28, 1))
        m_plats.append(MovingPlatform(4450, 460, 150, 22, 0, -150))
        platforms.append(Platform(4650, 380, 450, 30, 2))
        enemies.append(Enemy(4200, 460, 80, hp(5)))
        enemies.append(ShootingEnemy(4800, 340, 100, hp(4)))
        enemies.append(Enemy(4950, 340, 100, hp(5)))
