...
def build_level(level_id=1, difficulty=1.0):
    ...
    if level_id == 1:
        ...
        platforms.append(Platform(3200, 540, 200, 24, 2))
        platforms.append(Platform(3500, 500, 180, 24, 0))
        platforms.append(Platform(3750, 580, 250, 30, 1))

        enemies.append(Enemy(3300, 500, 80, hp(3)))
        enemies.append(FlyingEnemy(3600, 400, hp(2), float_height=340))
    ...
    # ── LEVEL 2: Plataformas — corrigido, sem espinhos duplos ─
        ...
        # Zona 4: Expansão final
        platforms.append(Platform(3600, 520, 200, 24, 2))
        platforms.append(Platform(3900, 560, 250, 30, 0))
        platforms.append(Platform(4200, 540, 180, 24, 1))

        enemies.append(ShootingEnemy(3700, 480, 80, hp(3)))
        enemies.append(Enemy(4000, 520, 100, hp(4)))
    ...
    # ── LEVEL 3: Puzzles — switches, portões, espinhos alternados ─
        ...
        # Zona 1: Intro + switch (REPOSICIONADOS v2)
        ...
        # Zona 4: Expansão final
        platforms.append(Platform(3800, 540, 200, 24, 2))
        platforms.append(Platform(4100, 500, 250, 30, 0))
        platforms.append(Platform(4400, 560, 200, 24, 1))

        enemies.append(Enemy(3900, 500, 100, hp(4)))
        enemies.append(ShootingEnemy(4200, 460, 80, hp(3)))
    ...
    # ── LEVEL 4: A Ascensão — desafio de pulo vertical ───────
        ...
        # Zona 4: Expansão final
        platforms.append(Platform(4200, 520, 220, 30, 2))
        platforms.append(Platform(4550, 480, 180, 24, 0))
        platforms.append(Platform(4850, 540, 250, 30, 1))

        enemies.append(FlyingEnemy(4300, 420, hp(3), float_height=360))
        enemies.append(Enemy(4600, 440, 100, hp(5)))
    ...
    # ── LEVEL 5: O Boss Final — arena corrigida ───────────────
        ...
        platforms.append(Platform(ARENA_X2+400, 0, 40, 900))   # parede direita arena (expandida)
