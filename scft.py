...
def build_level(level_id=1, difficulty=1.0):
    ...
    if level_id == 1:
        ...
        # Expanded area L1
        platforms.append(Platform(3100, 520, 200, 30))
        platforms.append(Platform(3400, 580, 400, 40))
        enemies.append(Enemy(3200, 510, 80, hp(4)))
        enemies.append(FlyingEnemy(3500, 500, hp(2), float_height=420))

        goal = LevelGoal(3900, 514)
    ...
    # ── LEVEL 2: Plataformas — corrigido, sem espinhos duplos ─
        ...
        # Expanded area L2
        platforms.append(Platform(3500, 540, 200, 30))
        platforms.append(Platform(3900, 600, 500, 40))
        enemies.append(ShootingEnemy(3600, 500, 70, hp(3)))
        enemies.append(Enemy(4000, 560, 100, hp(4)))
    ...
    # ── LEVEL 3: Puzzles — switches, portões, espinhos alternados ─
        ...
        # Expanded area L3
        platforms.append(Platform(3700, 540, 200, 30))
        platforms.append(Platform(4100, 580, 500, 40))
        enemies.append(FlyingEnemy(3800, 430, hp(2), float_height=380))
        enemies.append(ShootingEnemy(4200, 540, 80, hp(4)))
    ...
    # ── LEVEL 4: A Ascensão — desafio de pulo vertical ───────
        ...
        # Expanded area L4
        platforms.append(Platform(4100, 500, 200, 30))
        platforms.append(Platform(4400, 550, 600, 40))
        platforms.append(Platform(4850, 600, 200, 30))
        enemies.append(Enemy(4200, 460, 60, hp(5)))
        enemies.append(ShootingEnemy(4550, 510, 100, hp(4)))
        enemies.append(FlyingEnemy(4950, 520, hp(3), float_height=440))

        goal = LevelGoal(5100, 474)
