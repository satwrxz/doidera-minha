...
class HUD:
    ...
    def draw_start_screen(self,surf):
        ...
        floating_y = int(math.sin(t*2.0)*10)
        title=ft.render("SHADOWCROFT",True,C_UI_TITLE)
        draw_rect_alpha(surf,C_CHK_GLOW,
            (SCREEN_W//2-title.get_width()//2-12,SCREEN_H//2-68+floating_y,
             title.get_width()+24,72),gl//4)
        surf.blit(title,(SCREEN_W//2-title.get_width()//2,SCREEN_H//2-62+floating_y))
