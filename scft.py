...
def build_level(level_id=1, difficulty=1.0):
    ...
    if level_id == 1:
        ...
        # Expansão L1
        platforms.append(Platform(3000, 540, 150, 30, 2))
        platforms.append(Platform(3250, 480, 180, 24, 0))
        platforms.append(Platform(3500, 560, 200, 30, 1))
        platforms.append(Platform(3750, 600, 250, 40, 0))
        enemies.append(Enemy(3100, 500, 70, hp(4)))
        enemies.append(FlyingEnemy(3300, 400, hp(2), float_height=340))
        enemies.append(Enemy(3600, 520, 80, hp(4)))
    ...
    # ── LEVEL 2: Plataformas — corrigido, sem espinhos duplos ─
        ...
        # Expansão L2
        m_plats.append(MovingPlatform(3400, 540, 150, 22, 0, -200))
        platforms.append(Platform(3600, 380, 200, 30, 1))
        platforms.append(Platform(3900, 500, 250, 30, 2, hazard=True, hazard_timed=True, hazard_offset=30))
        platforms.append(Platform(4200, 580, 300, 40, 0))
        enemies.append(ShootingEnemy(3650, 340, 80, hp(3)))
        enemies.append(Enemy(4250, 540, 90, hp(4)))
        enemies.append(FlyingEnemy(4000, 300, hp(3), float_height=250))
    ...
    # ── LEVEL 3: Puzzles — switches, portões, espinhos alternados ─
        ...
        switches.append(Switch(600, 524)) # Switch reposicionado
        gates.append(Gate(1100, 340, 40, 220)) # Gate reposicionado
        ...
        # Expansão L3
        platforms.append(Platform(3600, 560, 250, 30, 1))
        m_plats.append(MovingPlatform(3900, 400, 140, 22, 200, 150))
        platforms.append(Platform(4200, 580, 500, 40, 0))
        enemies.append(Enemy(3650, 520, 80, hp(5)))
        enemies.append(ShootingEnemy(4300, 540, 80, hp(4)))
        enemies.append(FlyingEnemy(4500, 450, hp(3), float_height=380))
    ...
    # ── LEVEL 4: A Ascensão — desafio de pulo vertical ───────
        ...
        # Expansão L4
        platforms.append(Platform(4000, 580, 200, 30, 1))
        m_plats.append(MovingPlatform(4250, 580, 150, 22, 0, -250))
        platforms.append(Platform(4450, 400, 250, 30, 2))
        platforms.append(Platform(4750, 550, 400, 40, 0))
        enemies.append(Enemy(4500, 360, 80, hp(6)))
        enemies.append(ShootingEnemy(4800, 510, 80, hp(5)))
        enemies.append(FlyingEnemy(4300, 300, hp(4), float_height=200))
    ...
    # ── LEVEL 5: O Boss Final — arena corrigida ───────────────
        ...
        platforms.append(Platform(ARENA_X1, 560, (ARENA_X2-ARENA_X1)+400, 45, 0)) # Arena estendida
        ...
        platforms.append(Platform(ARENA_X2+400,    0, 40, 900))   # parede direita arena (reposicionada)
...
class Game:
    ...
    def _load_data(self):
        ...
        if os.path.exists("save_data.json"):
            try:
                ...
                print(f"Dados carregados: Level {self.unlocked}, Souls {self.souls}")
            except Exception as e:
                print(f"Erro ao carregar save_data.json: {e}")
    ...
    def _save_data(self):
        ...
        try:
            ...
            print(f"Erro ao salvar save_data.json: {e}")
