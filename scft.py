...
def build_level(level_id=1, difficulty=1.0):
    ...
    if level_id == 1:
        ...
        # Expanded Area Level 1
        platforms.append(Platform(2960, 500, 200, 30, 2))
        platforms.append(Platform(3200, 440, 200, 30, 0))
        platforms.append(Platform(3450, 560, 550, 40, 1))
        enemies.append(Enemy(3000, 460, 60, hp(4)))
        enemies.append(FlyingEnemy(3300, 380, hp(3), float_height=300))
        enemies.append(ShootingEnemy(3550, 520, 100, hp(3)))
        enemies.append(Enemy(3750, 520, 80, hp(4)))
    ...
    # ── LEVEL 2: Plataformas — corrigido, sem espinhos duplos ─
        ...
        # Expanded Area Level 2
        platforms.append(Platform(3360, 500, 250, 30, 1))
        m_plats.append(MovingPlatform(3650, 500, 140, 22, 0, -200))
        platforms.append(Platform(3850, 420, 200, 30, 2))
        platforms.append(Platform(4100, 600, 400, 40, 0))
        enemies.append(Enemy(3400, 460, 80, hp(4)))
        enemies.append(ShootingEnemy(3500, 460, 60, hp(3)))
        enemies.append(FlyingEnemy(3750, 350, hp(3), float_height=280))
        enemies.append(Enemy(4150, 560, 100, hp(5)))
        enemies.append(ShootingEnemy(4300, 560, 80, hp(4)))
    ...
    # ── LEVEL 3: Puzzles — switches, portões, espinhos alternados ─
        ...
        # Expanded Area Level 3
        platforms.append(Platform(3560, 520, 200, 30, 1, hazard=True, hazard_timed=True, hazard_offset=30))
        platforms.append(Platform(3800, 520, 300, 30, 0))
        m_plats.append(MovingPlatform(4150, 520, 130, 22, 200, 0))
        platforms.append(Platform(4400, 580, 400, 40, 2))
        enemies.append(ShootingEnemy(3850, 480, 80, hp(4)))
        enemies.append(Enemy(4000, 480, 60, hp(5)))
        enemies.append(FlyingEnemy(4250, 400, hp(3), float_height=320))
        enemies.append(Enemy(4450, 540, 100, hp(5)))
        enemies.append(ShootingEnemy(4600, 540, 80, hp(4)))
    ...
    # ── LEVEL 4: A Ascensão — desafio de pulo vertical ───────
        ...
        # Expanded Area Level 4
        platforms.append(Platform(3940, 450, 200, 30, 1))
        platforms.append(Platform(4200, 380, 200, 30, 0))
        platforms.append(Platform(4450, 310, 200, 30, 2))
        platforms.append(Platform(4700, 550, 500, 40, 1))
        enemies.append(Enemy(4000, 410, 60, hp(5)))
        enemies.append(ShootingEnemy(4250, 340, 60, hp(5)))
        enemies.append(FlyingEnemy(4500, 250, hp(4), float_height=180))
        enemies.append(Enemy(4750, 510, 120, hp(6)))
        enemies.append(ShootingEnemy(4950, 510, 100, hp(5)))
    ...
    # ── LEVEL 5: O Boss Final — arena corrigida ───────────────
        ...
        gates.append(Gate(ARENA_X2, 0, 40, 900))              # Boss Gate
...
class Game:
    ...
    def update(self):
        ...
        if self.current_level == 5:
            boss_dead = not any(isinstance(e, Boss) for e in self.enemies)
            if boss_dead: sw_active = True
