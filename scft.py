...
def build_level(level_id=1, difficulty=1.0):
    ...
    if level_id == 1:
        ...
        # Expanded content L1 (x > 2700)
        platforms.append(Platform(3000, 560, 500, 40, 1))
    ...
    # ── LEVEL 2: Plataformas — corrigido, sem espinhos duplos ─
        ...
        # Expanded content L2 (x > 3200)
        platforms.append(Platform(3500, 600, 400, 40, 1))
        m_plats.append(MovingPlatform(3950, 560, 140, 22, 200, -100))
        enemies.append(Enemy(3600, 560, 100, hp(5)))
        enemies.append(FlyingEnemy(3800, 480, hp(3), float_height=400))
    ...
    # ── LEVEL 3: Puzzles — switches, portões, espinhos alternados ─
        ...
        # Expanded content L3 (x > 3400)
        platforms.append(Platform(3700, 580, 500, 40, 0))
        enemies.append(Enemy(3800, 540, 120, hp(5)))
        enemies.append(ShootingEnemy(4000, 540, 100, hp(4)))
    ...
    # ── LEVEL 4: A Ascensão — desafio de pulo vertical ───────
        ...
        # Expanded content L4 (x > 3900)
        platforms.append(Platform(4100, 550, 600, 40, 1))
        enemies.append(Enemy(4200, 510, 150, hp(6)))
        enemies.append(ShootingEnemy(4400, 510, 120, hp(5)))
        enemies.append(FlyingEnemy(4600, 420, hp(4), float_height=350))
    ...
    # ── LEVEL 5: O Boss Final — arena corrigida ───────────────
        ...
        # Extended floor to accommodate LevelGoal beyond original arena end
        ...
        # Wall at ARENA_X2 is removed to allow player to reach the goal
        platforms.append(Platform(ARENA_X2 + 400, 0, 40, 900)) # parede final direita
