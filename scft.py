...
class Boss(Enemy):
    ...
    def update(self, platforms, player_rect, projectiles):
        ...
        self.rect.x=clamp(self.rect.x, self.arena_x1, self.arena_x2+400-self.rect.w)
...
def build_level(level_id=1, difficulty=1.0):
    ...
    if level_id == 1:
        ...
        # Expansão L1
        platforms.append(Platform(2900, 580, 300, 40, 0))
        platforms.append(Platform(3300, 520, 200, 24, 2))
        platforms.append(Platform(3600, 580, 400, 40, 0))
        enemies.append(Enemy(2950, 540, 60, hp(4)))
        enemies.append(Enemy(3350, 480, 50, hp(4)))
        enemies.append(FlyingEnemy(3150, 460, hp(2), float_height=380))

        goal = LevelGoal(3880, 504)
    ...
    # ── LEVEL 2: Plataformas — corrigido, sem espinhos duplos ─
        ...
        platforms.append(Platform(3700, 460, 180, 24, 2))
        platforms.append(Platform(4000, 540, 300, 40, 0))
        enemies.append(Enemy(3450, 480, 70, hp(4)))
        enemies.append(ShootingEnemy(3750, 420, 60, hp(3)))
        enemies.append(FlyingEnemy(3900, 380, hp(2), float_height=320))

        goal = LevelGoal(4250, 464)
    ...
    # ── LEVEL 3: Puzzles — switches, portões, espinhos alternados ─
        ...
        platforms.append(Platform(580, 560, 320, 30, 1))
        ...
        # Expansão L3
        platforms.append(Platform(3600, 540, 220, 30, 1))
        platforms.append(Platform(3900, 480, 180, 24, 2))
        platforms.append(Platform(4200, 560, 400, 40, 0))
        enemies.append(Enemy(3650, 500, 80, hp(4)))
        enemies.append(ShootingEnemy(3950, 440, 70, hp(3)))
        enemies.append(FlyingEnemy(4100, 420, hp(3), float_height=360))

        goal = LevelGoal(4550, 484)
    ...
    # ── LEVEL 4: A Ascensão — desafio de pulo vertical ───────
        ...
        # Expansão L4
        platforms.append(Platform(4000, 500, 200, 30, 1))
        platforms.append(Platform(4300, 440, 220, 24, 2))
        platforms.append(Platform(4650, 520, 450, 40, 0))
        enemies.append(Enemy(4050, 460, 80, hp(5)))
        enemies.append(ShootingEnemy(4350, 400, 70, hp(4)))
        enemies.append(FlyingEnemy(4500, 350, hp(3), float_height=290))
        enemies.append(Enemy(4800, 480, 100, hp(5)))

        goal = LevelGoal(5050, 444)
