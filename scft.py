...
class Switch:
    ...
    def draw(self,surf,cx,cy):
        ...
        pygame.draw.rect(surf,col,(rx,ry,40,40),border_radius=5)
        pygame.draw.rect(surf,C_WHITE,(rx,ry,40,40),2,border_radius=5)
        if self.active:
            draw_circle_alpha(surf,(100,255,100),(rx+20,ry+20),22,80)
...
def build_level(level_id=1, difficulty=1.0):
    ...
    if level_id == 1:
        ...
        enemies.append(FlyingEnemy(3700, 480, hp(2), float_height=420))
    ...
    # ── LEVEL 2: Plataformas — corrigido, sem espinhos duplos ─
        ...
        # EXPANSÃO LEVEL 2
        m_plats.append(MovingPlatform(3400, 580, 150, 22, 200, -100))
        platforms.append(Platform(3800, 520, 400, 30, 1))
        enemies.append(Enemy(3900, 480, 100, hp(4)))
        enemies.append(ShootingEnemy(4100, 480, 80, hp(3)))
        enemies.append(FlyingEnemy(4000, 400, hp(2), float_height=350))

        goal = LevelGoal(4380, 434)
    ...
    # ── LEVEL 3: Puzzles — switches, portões, espinhos alternados ─
        ...
        # Zona 1: Intro + switch (REPOSICIONADO: Switch em 600, Gate em 1100)
        ...
        # EXPANSÃO LEVEL 3
        platforms.append(Platform(3600, 550, 400, 30, 1))
        platforms.append(Platform(4100, 600, 600, 40, 0))
        enemies.append(Enemy(3700, 510, 100, hp(4)))
        enemies.append(ShootingEnemy(4200, 560, 80, hp(3)))
        enemies.append(FlyingEnemy(4400, 480, hp(3), float_height=420))
    ...
    # ── LEVEL 4: A Ascensão — desafio de pulo vertical ───────
        ...
        # EXPANSÃO LEVEL 4
        platforms.append(Platform(4000, 500, 200, 28, 1))
        m_plats.append(MovingPlatform(4300, 550, 160, 22, 200, 0))
        platforms.append(Platform(4600, 600, 500, 40, 0))
        enemies.append(Enemy(4100, 460, 60, hp(5)))
        enemies.append(ShootingEnemy(4700, 560, 100, hp(4)))
        enemies.append(FlyingEnemy(4900, 450, hp(3), float_height=380))

        goal = LevelGoal(5080, 514)
