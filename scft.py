...
def build_level(level_id=1, difficulty=1.0):
    ...
    if level_id == 1:
        ...
        # Novo conteúdo p/ área expandida
        platforms.append(Platform(2700, 540, 250, 24, 2))
        platforms.append(Platform(3050, 600, 600, 40, 1))
        enemies.append(Enemy(3150, 560, 120, hp(4)))
        enemies.append(ShootingEnemy(3400, 560, 100, hp(3)))
        enemies.append(FlyingEnemy(3500, 480, hp(3), float_height=420))
    ...
    # ── LEVEL 2: Plataformas — corrigido, sem espinhos duplos ─
        ...
        # Novo conteúdo p/ área expandida
        m_plats.append(MovingPlatform(3450, 560, 140, 22, 220, 0))
        platforms.append(Platform(3800, 580, 400, 40, 1))
        enemies.append(Enemy(3900, 540, 120, hp(5)))
        enemies.append(ShootingEnemy(4050, 540, 100, hp(4)))
    ...
    # ── LEVEL 3: Puzzles — switches, portões, espinhos alternados ─
        ...
        # Novo conteúdo p/ área expandida
        platforms.append(Platform(3600, 540, 280, 30, 1))
        m_plats.append(MovingPlatform(3950, 540, 140, 22, 0, -180))
        platforms.append(Platform(4150, 580, 500, 40, 0))
        enemies.append(Enemy(4250, 540, 120, hp(5)))
        enemies.append(ShootingEnemy(4450, 540, 100, hp(4)))
    ...
    # ── LEVEL 4: A Ascensão — desafio de pulo vertical ───────
        ...
        # Novo conteúdo p/ área expandida
        platforms.append(Platform(4050, 480, 200, 24, 2))
        platforms.append(Platform(4350, 420, 200, 24, 1))
        platforms.append(Platform(4650, 550, 450, 40, 0))
        enemies.append(Enemy(4750, 510, 120, hp(6)))
        enemies.append(ShootingEnemy(4900, 510, 100, hp(5)))
        enemies.append(FlyingEnemy(4800, 400, hp(4), float_height=340))
