...
class Enemy:
    ...
    def update(self, platforms, player_rect):
        ...
        # Borda de plataforma: Lógica de borda e pulo
...
def build_level(level_id=1, difficulty=1.0):
    ...
    if level_id == 1:
        ...
        # Expansão Level 1
        platforms.append(Platform(3100, 540, 220, 30, 1))
        platforms.append(Platform(3400, 480, 250, 30, 2))
        enemies.append(Enemy(3150, 500, 60, hp(4)))
        enemies.append(ShootingEnemy(3450, 440, 60, hp(3)))
        enemies.append(FlyingEnemy(3300, 420, hp(2), float_height=360))

        goal = LevelGoal(3880, 434)
    ...
    # ── LEVEL 2: Plataformas — corrigido, sem espinhos duplos ─
        ...
        # Expansão Level 2
        m_plats.append(MovingPlatform(3400, 500, 140, 22, 0, 160))
        platforms.append(Platform(3650, 580, 400, 40, 1))
        platforms.append(Platform(4100, 520, 250, 30, 2))
        enemies.append(ShootingEnemy(3700, 540, 80, hp(4)))
        enemies.append(Enemy(3850, 540, 60, hp(5)))
        enemies.append(FlyingEnemy(4050, 440, hp(3), float_height=380))
    ...
    # ── LEVEL 3: Puzzles — switches, portões, espinhos alternados ─
        ...
        # Expansão Level 3
        platforms.append(Platform(3600, 540, 250, 30, 1))
        platforms.append(Platform(3950, 480, 300, 40, 0))
        platforms.append(Platform(4350, 560, 300, 40, 2))
        enemies.append(Enemy(3650, 500, 80, hp(5)))
        enemies.append(ShootingEnemy(4000, 440, 70, hp(4)))
        enemies.append(Enemy(4400, 520, 90, hp(5)))
    ...
    # ── LEVEL 4: A Ascensão — desafio de pulo vertical ───────
        ...
        # Expansão Level 4
        platforms.append(Platform(4000, 480, 250, 30, 1))
        platforms.append(Platform(4350, 420, 200, 25, 2))
        platforms.append(Platform(4650, 500, 450, 40, 0))
        enemies.append(Enemy(4050, 440, 80, hp(6)))
        enemies.append(FlyingEnemy(4300, 360, hp(4), float_height=300))
        enemies.append(ShootingEnemy(4700, 460, 90, hp(5)))
        enemies.append(Enemy(4900, 460, 90, hp(6)))

        goal = LevelGoal(5080, 424)
...
class Game:
    ...
    def update(self):
        ...
        if self.entry_fade < 0: self.entry_fade = 0
