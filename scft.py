...
def build_level(level_id=1, difficulty=1.0):
    ...
    if level_id == 1:
        ...
        platforms.append(Platform(2900, 520, 400, 40, 1))
        platforms.append(Platform(3400, 460, 300, 40, 2))
        enemies.append(Enemy(3000, 480, 100, hp(4)))
        enemies.append(FlyingEnemy(3300, 400, hp(3), float_height=340))
    ...
    # ── LEVEL 2: Plataformas — corrigido, sem espinhos duplos ─
        ...
        platforms.append(Platform(3900, 500, 300, 40, 1))
        enemies.append(Enemy(3500, 540, 100, hp(5)))
        enemies.append(ShootingEnemy(4000, 460, 80, hp(4)))
    ...
    # ── LEVEL 3: Puzzles — switches, portões, espinhos alternados ─
        ...
        # Zona 4: Expansão final
        platforms.append(Platform(3700, 540, 400, 40, 2))
        platforms.append(Platform(4200, 480, 300, 40, 0))
        enemies.append(Enemy(3800, 500, 100, hp(5)))
    ...
    # ── LEVEL 4: A Ascensão — desafio de pulo vertical ───────
        ...
        # Zona 4: Expansão final
        platforms.append(Platform(4100, 520, 500, 40, 1))
        platforms.append(Platform(4700, 460, 300, 40, 2))
        enemies.append(Enemy(4300, 480, 100, hp(6)))
        enemies.append(ShootingEnemy(4800, 420, 80, hp(5)))
    ...
    # ── LEVEL 5: O Boss Final — arena corrigida ───────────────
        ...
        platforms.append(Platform(ARENA_X1, 560, ARENA_X2-ARENA_X1+400, 45, 0)) # Extensão do chão pós-arena

        # Paredes físicas da arena (impedem saída)
        platforms.append(Platform(ARENA_X1-40, 0, 40, 900))   # parede esquerda arena
        # O Gate que abre após o boss está em ARENA_X2
...
class Game:
    ...
    def update(self):
        ...
        # Portão do boss no Level 5 abre quando o boss morre
