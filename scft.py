...
def build_level(level_id=1, difficulty=1.0):
    ...
    # ── LEVEL 5: O Boss Final — arena corrigida ───────────────
        ...
        # platforms.append(Platform(ARENA_X2,    0, 40, 900))   # parede direita arena -> Vai ser um portão
        ...
        # Portão que abre ao derrotar o boss
...
class Game:
    ...
    def _load_data(self):
        ...
        except (FileNotFoundError, json.JSONDecodeError, IOError, OSError): pass
