...
def build_level(level_id=1, difficulty=1.0):
    ...
    if level_id == 1:
        ...
        # Expanded content L1
        platforms.append(Platform(3200, 550, 200, 30, 0))
        enemies.append(Enemy(3250, 510, 80, hp(4)))
        platforms.append(Platform(3550, 500, 180, 24, 2))
        enemies.append(FlyingEnemy(3600, 420, hp(3), float_height=360))
    ...
    # ── LEVEL 2: Plataformas — corrigido, sem espinhos duplos ─
        ...
        # Expanded content L2
        platforms.append(Platform(3600, 520, 200, 30, 1))
        enemies.append(Enemy(3650, 480, 80, hp(4)))
        platforms.append(Platform(4000, 550, 220, 40, 0))
        enemies.append(ShootingEnemy(4100, 510, 80, hp(3)))
    ...
    # ── LEVEL 3: Puzzles — switches, portões, espinhos alternados ─
        ...
        # Expanded content L3
        platforms.append(Platform(3800, 540, 200, 30, 2))
        enemies.append(Enemy(3850, 500, 80, hp(4)))
        platforms.append(Platform(4200, 580, 250, 40, 0))
    ...
    # ── LEVEL 4: A Ascensão — desafio de pulo vertical ───────
        ...
        # Expanded content L4
        platforms.append(Platform(4300, 480, 200, 30, 1))
        enemies.append(Enemy(4350, 440, 80, hp(5)))
        platforms.append(Platform(4700, 520, 220, 40, 0))
        enemies.append(ShootingEnemy(4800, 480, 80, hp(4)))
    ...
    # ── LEVEL 5: O Boss Final — arena corrigida ───────────────
        ...
        # Paredes invisíveis laterais da arena (impedem saída do boss) - REMOVED
