...
class Enemy:
    ...
    def update(self, platforms, player_rect):
        ...
        # Borda de plataforma: PATROL vira, CHASE/ATTACK pula
...
def build_level(level_id=1, difficulty=1.0):
    ...
    if level_id == 1:
        ...
        # EXPANSÃO v2
        platforms.append(Platform(3000, 540, 300, 40, 1))
        platforms.append(Platform(3400, 560, 500, 40, 0))
        enemies.append(Enemy(3100, 500, 100, hp(4)))
        enemies.append(ShootingEnemy(3500, 520, 80, hp(3)))
        enemies.append(Enemy(3700, 520, 80, hp(4)))
    ...
    # ── LEVEL 2: Plataformas — corrigido, sem espinhos duplos ─
        ...
        # EXPANSÃO v2
        m_plats.append(MovingPlatform(3400, 500, 140, 22, 0, -200))
        platforms.append(Platform(3600, 540, 300, 40, 1))
        platforms.append(Platform(4000, 580, 400, 40, 0))
        enemies.append(ShootingEnemy(3700, 500, 80, hp(4)))
        enemies.append(FlyingEnemy(3900, 400, hp(3), float_height=350))
        enemies.append(Enemy(4100, 540, 100, hp(4)))
    ...
    # ── LEVEL 3: Puzzles — switches, portões, espinhos alternados ─
        ...
        orbs.append(HealthOrb(1500, 470))
        checkpoints.append(Checkpoint(1300, 516))
        ...
        # EXPANSÃO v2
        platforms.append(Platform(3800, 560, 400, 40, 1))
        platforms.append(Platform(4300, 580, 400, 40, 0))
        enemies.append(ShootingEnemy(3900, 520, 80, hp(4)))
        enemies.append(Enemy(4400, 540, 100, hp(5)))

        orbs.append(HealthOrb(2800, 490))
        checkpoints.append(Checkpoint(2870, 536))
    ...
    # ── LEVEL 4: A Ascensão — desafio de pulo vertical ───────
        ...
        # EXPANSÃO v2
        platforms.append(Platform(4000, 540, 300, 40, 2))
        m_plats.append(MovingPlatform(4400, 500, 160, 22, 0, -220))
        platforms.append(Platform(4700, 560, 400, 40, 0))
        enemies.append(Enemy(4100, 500, 100, hp(5)))
        enemies.append(ShootingEnemy(4800, 520, 120, hp(5)))
    ...
    # ── LEVEL 5: O Boss Final — arena corrigida ───────────────
        ...
        # EXTENSÃO v2: width of 400 pixels beyond ARENA_X2
        ...
        # PAREDE DIREITA REMOVIDA v2 para acesso ao Goal
