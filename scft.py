...
def build_level(level_id=1, difficulty=1.0):
    ...
    if level_id == 1:
        ...
        # Extensão v2.0
        platforms.append(Platform(3000, 540, 250, 30, 1))
        platforms.append(Platform(3300, 480, 200, 30, 2))
        platforms.append(Platform(3600, 540, 300, 40, 0))
        enemies.append(Enemy(3100, 500, 60, hp(4)))
        enemies.append(FlyingEnemy(3400, 400, hp(3), float_height=340))

        goal = LevelGoal(3800, 464)
    ...
    # ── LEVEL 2: Plataformas — corrigido, sem espinhos duplos ─
        ...
        # Extensão v2.0
        platforms.append(Platform(3400, 520, 200, 30, 1))
        m_plats.append(MovingPlatform(3650, 520, 140, 22, 200, -100))
        platforms.append(Platform(3900, 460, 200, 30, 2))
        platforms.append(Platform(4150, 540, 300, 40, 0))
        enemies.append(Enemy(3450, 480, 50, hp(4)))
        enemies.append(ShootingEnemy(4200, 500, 80, hp(4)))
        enemies.append(FlyingEnemy(3800, 380, hp(3), float_height=320))

        goal = LevelGoal(4350, 464)
    ...
    # ── LEVEL 3: Puzzles — switches, portões, espinhos alternados ─
        ...
        platforms.append(Platform(3900, 500, 200, 30, 2, hazard=True, hazard_timed=True))
        platforms.append(Platform(4150, 560, 200, 30, 0))
        platforms.append(Platform(4400, 600, 350, 40, 0))
        enemies.append(Enemy(3650, 520, 60, hp(5)))
        enemies.append(ShootingEnemy(4200, 520, 70, hp(4)))
        enemies.append(FlyingEnemy(4500, 500, hp(3), float_height=420))
    ...
    # ── LEVEL 4: A Ascensão — desafio de pulo vertical ───────
        ...
        # Extensão v2.0
        platforms.append(Platform(4000, 500, 180, 28, 1))
        platforms.append(Platform(4250, 440, 180, 28, 2))
        platforms.append(Platform(4500, 380, 180, 28, 1))
        platforms.append(Platform(4750, 320, 200, 28, 0))
        platforms.append(Platform(5000, 400, 150, 30, 2))
        enemies.append(Enemy(4050, 460, 40, hp(5)))
        enemies.append(ShootingEnemy(4550, 340, 60, hp(5)))
        enemies.append(FlyingEnemy(4800, 220, hp(4), float_height=160))
        enemies.append(Enemy(5020, 360, 30, hp(5)))

        goal = LevelGoal(5080, 324)
    ...
    # ── LEVEL 5: O Boss Final — arena corrigida ───────────────
        ...
        platforms.append(Platform(ARENA_X2+400, 0, 40, 900))  # parede direita arena (estendida)
        ...
        boss = Boss(2400, 470, hp(35), arena_x1=ARENA_X1+20, arena_x2=ARENA_X2+380)
        enemies.append(boss)
