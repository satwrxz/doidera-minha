...
def build_level(level_id=1, difficulty=1.0):
    ...
    if level_id == 1:
        ...
        # Expanded area
        platforms.append(Platform(2800, 500, 400, 40, 1))
        enemies.append(Enemy(2900, 460, 80, hp(4)))
        platforms.append(Platform(3300, 450, 300, 40, 0))
        enemies.append(ShootingEnemy(3400, 410, 60, hp(3)))
        platforms.append(Platform(3700, 460, 250, 40, 2))
        goal = LevelGoal(3850, 384)
    ...
    # ── LEVEL 2: Plataformas — corrigido, sem espinhos duplos ─
        ...
        # Expanded area
        platforms.append(Platform(3400, 500, 400, 40, 1))
        enemies.append(Enemy(3500, 460, 100, hp(4)))
        m_plats.append(MovingPlatform(3900, 450, 150, 22, 0, 150))
        platforms.append(Platform(4150, 580, 300, 40, 0))
        goal = LevelGoal(4350, 504)
    ...
    # ── LEVEL 3: Puzzles — switches, portões, espinhos alternados ─
        ...
        platforms.append(Platform(730, 560, 450, 30, 2))
        ...
        # Expanded area
        platforms.append(Platform(3600, 500, 400, 40, 1))
        enemies.append(Enemy(3700, 460, 100, hp(5)))
        platforms.append(Platform(4100, 450, 300, 40, 0))
        enemies.append(ShootingEnemy(4200, 410, 80, hp(4)))
        platforms.append(Platform(4500, 550, 250, 40, 2))
    ...
    # ── LEVEL 4: A Ascensão — desafio de pulo vertical ───────
        ...
        platforms.append(Platform(4500, 400, 300, 40, 0))
        enemies.append(FlyingEnemy(4650, 300, hp(4), float_height=200))
        platforms.append(Platform(4900, 500, 250, 40, 2))
        goal = LevelGoal(5050, 424)
