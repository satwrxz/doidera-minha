...
def build_level(level_id=1, difficulty=1.0):
    ...
    if level_id == 1:
        ...
        # Zona Expandida (x > 2700)
        platforms.append(Platform(2700, 520, 200, 24, 2))
        platforms.append(Platform(3000, 580, 400, 40, 1))
        platforms.append(Platform(3450, 520, 250, 30, 0))

        enemies.append(Enemy(2750, 480, 60, hp(4)))
        enemies.append(FlyingEnemy(3100, 450, hp(3), float_height=380))
        enemies.append(Enemy(3480, 480, 80, hp(4)))
        enemies.append(ShootingEnemy(3600, 480, 80, hp(3)))
    ...
    # ── LEVEL 2: Plataformas — corrigido, sem espinhos duplos ─
        ...
        # Zona Expandida (x > 3300)
        m_plats.append(MovingPlatform(3400, 540, 130, 22, 200, -100))
        platforms.append(Platform(3700, 500, 300, 30, 1))
        platforms.append(Platform(4050, 580, 400, 40, 0))

        enemies.append(ShootingEnemy(3750, 460, 80, hp(3)))
        enemies.append(FlyingEnemy(3900, 400, hp(3), float_height=340))
        enemies.append(Enemy(4100, 540, 100, hp(5)))
        enemies.append(Enemy(4250, 540, 80, hp(5)))
    ...
    # ── LEVEL 3: Puzzles — switches, portões, espinhos alternados ─
        ...
        # Zona Expandida (x > 3500)
        platforms.append(Platform(3500, 540, 250, 30, 1))
        m_plats.append(MovingPlatform(3800, 500, 140, 22, 0, 150))
        platforms.append(Platform(4000, 580, 350, 40, 0))
        platforms.append(Platform(4400, 540, 300, 30, 2))

        enemies.append(ShootingEnemy(3550, 500, 90, hp(4)))
        enemies.append(FlyingEnemy(3700, 420, hp(3), float_height=350))
        enemies.append(Enemy(4050, 540, 100, hp(5)))
        enemies.append(ShootingEnemy(4150, 540, 80, hp(4)))
        enemies.append(FlyingEnemy(4300, 480, hp(3), float_height=400))
        enemies.append(Enemy(4450, 500, 80, hp(5)))
    ...
    # ── LEVEL 4: A Ascensão — desafio de pulo vertical ───────
        ...
        # Zona Expandida (x > 4000)
        platforms.append(Platform(4000, 500, 250, 30, 1))
        platforms.append(Platform(4300, 450, 200, 24, 2))
        platforms.append(Platform(4550, 520, 300, 35, 0))
        platforms.append(Platform(4900, 560, 200, 40, 1))

        enemies.append(Enemy(4050, 460, 70, hp(5)))
        enemies.append(ShootingEnemy(4100, 460, 60, hp(4)))
        enemies.append(FlyingEnemy(4250, 380, hp(4), float_height=320))
        enemies.append(Enemy(4600, 480, 100, hp(5)))
        enemies.append(ShootingEnemy(4750, 480, 80, hp(4)))
        enemies.append(Enemy(4950, 520, 60, hp(5)))
    ...
    # ── LEVEL 5: O Boss Final — arena corrigida ───────────────
        ...
        # Goal após o boss (x > 3600)
        platforms.append(Platform(3600, 560, 300, 45, 0))
        enemies.append(FlyingEnemy(3750, 450, hp(4), float_height=400))
