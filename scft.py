...
def build_level(level_id=1, difficulty=1.0):
    ...
    if level_id == 1:
        ...
        # Zona 4: Expansão final
        platforms.append(Platform(2960, 500, 240, 24, 2))
        platforms.append(Platform(3200, 600, 500, 40, 0))
        enemies.append(Enemy(3300, 560, 80, hp(4)))
        enemies.append(FlyingEnemy(3450, 480, hp(2), float_height=420))
        orbs.append(HealthOrb(3400, 540))
    ...
    # ── LEVEL 2: Plataformas — corrigido, sem espinhos duplos ─
        ...
        # Zona 4: Expansão final
        platforms.append(Platform(3360, 500, 250, 28, 1))
        m_plats.append(MovingPlatform(3610, 500, 140, 22, 220, 0))
        platforms.append(Platform(3850, 580, 500, 40, 0))
        enemies.append(Enemy(3900, 540, 100, hp(4)))
        enemies.append(ShootingEnemy(4100, 540, 80, hp(3)))
        orbs.append(HealthOrb(4000, 500))

        goal = LevelGoal(4340, 504)
    ...
    # ── LEVEL 3: Puzzles — switches, portões, espinhos alternados ─
        ...
        # Zona 4: Expansão final
        platforms.append(Platform(3560, 560, 320, 40, 1))
        platforms.append(Platform(3880, 500, 200, 28, hazard=True, hazard_timed=True, hazard_offset=30))
        platforms.append(Platform(4080, 600, 600, 40, 0))
        enemies.append(Enemy(4150, 560, 120, hp(5)))
        enemies.append(ShootingEnemy(4300, 560, 100, hp(4)))
        orbs.append(HealthOrb(4400, 500))
    ...
    # ── LEVEL 4: A Ascensão — desafio de pulo vertical ───────
        ...
        # Zona 5: Expansão final
        platforms.append(Platform(3940, 480, 240, 28, 2))
        platforms.append(Platform(4180, 400, 200, 28, 1))
        platforms.append(Platform(4380, 550, 700, 40, 0))
        enemies.append(Enemy(4450, 510, 120, hp(5)))
        enemies.append(ShootingEnemy(4650, 510, 100, hp(4)))
        enemies.append(FlyingEnemy(4800, 400, hp(3), float_height=340))
        orbs.append(HealthOrb(4700, 450))
    ...
    # ── LEVEL 5: O Boss Final — arena corrigida ───────────────
        ...
        # Paredes invisíveis laterais da arena removidas conforme solicitado
