...
def build_level(level_id=1, difficulty=1.0):
    ...
    if level_id == 1:
        ...
        platforms.append(Platform(2280, 590, 1720, 40, 0)) # Estende chão até o fim
    ...
    # ── LEVEL 2: Plataformas — corrigido, sem espinhos duplos ─
        ...
        platforms.append(Platform(2980, 580, 1520, 40, 0)) # Estende chão
    ...
    # ── LEVEL 3: Puzzles — switches, portões, espinhos alternados ─
        ...
        platforms.append(Platform(3020, 600, 1780, 40, 0)) # Estende chão
    ...
    # ── LEVEL 4: A Ascensão — desafio de pulo vertical ───────
        ...
        platforms.append(Platform(3040, 550, 2160, 40, 0)) # Estende chão
    ...
    def draw(self):
        ...
        if self.state==self.S_SELECT:
            ...
            if self.reset_timer > 0:
                msg = "Segure K para resetar..." if self.reset_timer < 120 else "Progresso Resetado!"
                txt = pygame.font.SysFont("consolas", 18, bold=True).render(msg, True, (255, 100, 100))
                screen.blit(txt, (SCREEN_W//2 - txt.get_width()//2, 670))
