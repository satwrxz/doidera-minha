...
class HUD:
    ...
    def draw_level_select(self,surf,unlocked,souls,health_upgrades):
        ...
        hint=fs.render("Teclas 1-5 | ESC sair | E fácil | N normal | H difícil | K reset",True,(100,95,130))
...
def build_level(level_id=1, difficulty=1.0):
    ...
    if level_id == 1:
        ...
        # Expanded area L1
        platforms.append(Platform(3000, 550, 200, 30, 1))
        platforms.append(Platform(3300, 500, 180, 24, 2))
        platforms.append(Platform(3550, 560, 350, 40, 0))
        enemies.append(Enemy(3050, 510, 60, hp(4)))
        enemies.append(ShootingEnemy(3350, 460, 50, hp(3)))
        enemies.append(Enemy(3650, 520, 80, hp(4)))
    ...
    # ── LEVEL 2: Plataformas — corrigido, sem espinhos duplos ─
        ...
        # Expanded area L2
        platforms.append(Platform(3400, 540, 200, 30, 1))
        m_plats.append(MovingPlatform(3650, 500, 130, 22, 0, -150))
        platforms.append(Platform(3850, 580, 250, 40, 0))
        platforms.append(Platform(4150, 520, 200, 30, 2))
        enemies.append(Enemy(3450, 500, 70, hp(4)))
        enemies.append(FlyingEnemy(3700, 400, hp(3), float_height=340))
        enemies.append(ShootingEnemy(3900, 540, 60, hp(3)))
        enemies.append(Enemy(4200, 480, 60, hp(4)))
    ...
    # ── LEVEL 3: Puzzles — switches, portões, espinhos alternados ─
        ...
        # Zona 1: Intro + switch (REPOSITIONED)
        platforms.append(Platform(  0, 620, 500, 40, 0))
        platforms.append(Platform(550, 560, 150, 30, 1))
        ...
        # Expanded area L3
        platforms.append(Platform(3600, 580, 200, 30, 1))
        platforms.append(Platform(3900, 540, 150, 28, 1, hazard=True, hazard_timed=True, hazard_offset=30))
        platforms.append(Platform(4150, 560, 220, 30, 2))
        platforms.append(Platform(4450, 600, 300, 40, 0))
        enemies.append(Enemy(3650, 540, 70, hp(5)))
        enemies.append(ShootingEnemy(4200, 520, 60, hp(4)))
        enemies.append(FlyingEnemy(4350, 450, hp(3), float_height=380))
    ...
    # ── LEVEL 4: A Ascensão — desafio de pulo vertical ───────
        ...
        # Expanded area L4
        platforms.append(Platform(4000, 500, 180, 26, 1))
        platforms.append(Platform(4250, 440, 160, 24, 2))
        platforms.append(Platform(4500, 540, 450, 40, 0))
        enemies.append(Enemy(4050, 460, 60, hp(5)))
        enemies.append(FlyingEnemy(4300, 350, hp(4), float_height=280))
        enemies.append(ShootingEnemy(4600, 500, 80, hp(4)))
        enemies.append(Enemy(4800, 500, 100, hp(5)))
    ...
    # ── LEVEL 5: O Boss Final — arena corrigida ───────────────
        ...
        gates.append(Gate(ARENA_X2, 0, 40, 600))             # boss gate arena exit
...
class Game:
    ...
    def _reset_progress(self):
        ...
        self._save_data()
        self._init_game()
        self.hud.show_message("Progresso Resetado!", 90)
