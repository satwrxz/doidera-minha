...
def build_level(level_id=1, difficulty=1.0):
    ...
    if level_id == 1:
        ...
        # Novo conteúdo L1 (x > 2700)
        platforms.append(Platform(3000, 540, 200, 24, 2))
        platforms.append(Platform(3300, 600, 500, 40, 1))
        enemies.append(Enemy(3350, 550, 100, hp(4)))
        enemies.append(ShootingEnemy(3550, 550, 80, hp(3)))
        enemies.append(FlyingEnemy(3700, 450, hp(2), float_height=380))
    ...
    # ── LEVEL 2: Plataformas — corrigido, sem espinhos duplos ─
        ...
        # Novo conteúdo L2 (x > 3240)
        m_plats.append(MovingPlatform(3400, 540, 140, 22, 0, -180))
        platforms.append(Platform(3600, 580, 300, 40, 0))
        enemies.append(Enemy(3650, 540, 80, hp(4)))
        enemies.append(ShootingEnemy(3800, 540, 80, hp(3)))
        platforms.append(Platform(4000, 540, 400, 40, 1))
        enemies.append(FlyingEnemy(4200, 440, hp(2), float_height=360))
    ...
    # ── LEVEL 3: Puzzles — switches, portões, espinhos alternados ─
        ...
        # Novo conteúdo L3 (x > 3450)
        platforms.append(Platform(3600, 560, 200, 28, 1, hazard=True, hazard_timed=True, hazard_offset=30))
        platforms.append(Platform(3900, 600, 400, 40, 0))
        enemies.append(Enemy(3950, 560, 100, hp(4)))
        m_plats.append(MovingPlatform(4400, 560, 130, 22, 0, -200))
        enemies.append(ShootingEnemy(4500, 360, 80, hp(3)))
    ...
    # ── LEVEL 4: A Ascensão — desafio de pulo vertical ───────
        ...
        # Novo conteúdo L4 (x > 3880)
        platforms.append(Platform(4000, 500, 180, 24, 2))
        platforms.append(Platform(4250, 440, 180, 24, 0))
        platforms.append(Platform(4500, 550, 600, 40, 1))
        enemies.append(Enemy(4550, 510, 120, hp(5)))
        enemies.append(ShootingEnemy(4750, 510, 100, hp(4)))
        enemies.append(FlyingEnemy(4900, 410, hp(3), float_height=330))
    ...
    # ── LEVEL 5: O Boss Final — arena corrigida ───────────────
        ...
        # Chão estendido além de ARENA_X2
        platforms.append(Platform(ARENA_X1, 560, 4000-ARENA_X1, 45, 0))
