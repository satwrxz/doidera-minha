...
def build_level(level_id=1, difficulty=1.0):
    ...
    if level_id == 1:
        ...
        # Expansão x > 2700
        platforms.append(Platform(3000, 560, 400, 40, 1))
        platforms.append(Platform(3200, 480, 150, 24, 2))
        platforms.append(Platform(3450, 600, 500, 40, 0))

        enemies.append(Enemy(3050, 520, 80, hp(4)))
        enemies.append(FlyingEnemy(3250, 440, hp(3), float_height=380))
        enemies.append(Enemy(3550, 560, 100, hp(4)))
    ...
    # ── LEVEL 2: Plataformas — corrigido, sem espinhos duplos ─
        ...
        # Expansão x > 2700
        m_plats.append(MovingPlatform(3400, 540, 140, 22, 0, -180))
        platforms.append(Platform(3600, 580, 400, 40, 1))
        platforms.append(Platform(4100, 520, 300, 40, 0))

        enemies.append(FlyingEnemy(3800, 420, hp(3), float_height=360))
        enemies.append(ShootingEnemy(4150, 480, 80, hp(4)))
        enemies.append(Enemy(4250, 480, 70, hp(4)))
    ...
    # ── LEVEL 3: Puzzles — switches, portões, espinhos alternados ─
        ...
        # Expansão x > 2700
        platforms.append(Platform(3600, 560, 400, 40, 1))
        platforms.append(Platform(4100, 500, 300, 40, 0))
        platforms.append(Platform(4400, 580, 300, 40, 2))

        enemies.append(Enemy(3650, 520, 100, hp(4)))
        enemies.append(ShootingEnemy(4150, 460, 80, hp(4)))
        enemies.append(FlyingEnemy(4300, 420, hp(3), float_height=360))
    ...
    # ── LEVEL 4: A Ascensão — desafio de pulo vertical ───────
        ...
        # Expansão x > 2700
        platforms.append(Platform(4100, 580, 400, 40, 1))
        platforms.append(Platform(4400, 500, 200, 30, 2))
        platforms.append(Platform(4700, 620, 400, 40, 0))

        enemies.append(Enemy(4150, 540, 100, hp(5)))
        enemies.append(ShootingEnemy(4450, 460, 80, hp(4)))
        enemies.append(FlyingEnemy(4750, 380, hp(4), float_height=320))

        goal = LevelGoal(5080, 534)
    ...
    # ── LEVEL 5: O Boss Final — arena corrigida ───────────────
        ...
        # Chão estendido 400px além de ARENA_X2
        ...
        platforms.append(Platform(ARENA_X2 + 400, 0, 40, 900))   # parede direita arena (movida +400px)
...
class Game:
    ...
    def update(self):
        ...
        # ── Playing ───────────────────────────────────────────
        if self.entry_fade > 0: self.entry_fade -= 4
