...
def build_level(level_id=1, difficulty=1.0):
    ...
    if level_id == 1:
        ...
        platforms.append(Platform(3250, 460, 180, 24, 0))
        platforms.append(Platform(3500, 540, 450, 40, 1))
        enemies.append(Enemy(3100, 480, 60, hp(4)))
        enemies.append(ShootingEnemy(3300, 420, 70, hp(3)))
        enemies.append(Enemy(3600, 500, 100, hp(4)))
        enemies.append(FlyingEnemy(3750, 450, hp(2), float_height=380))
    ...
    # ── LEVEL 2: Plataformas — corrigido, sem espinhos duplos ─
        ...
        # Zona 4: Expansão v2.0
        m_plats.append(MovingPlatform(3400, 500, 150, 22, 0, -150))
        platforms.append(Platform(3650, 450, 250, 30, 1))
        m_plats.append(MovingPlatform(3950, 450, 140, 22, 250, 100))
        platforms.append(Platform(4250, 580, 300, 40, 0))
        enemies.append(FlyingEnemy(3700, 380, hp(3), float_height=320))
        enemies.append(ShootingEnemy(3750, 410, 80, hp(3)))
    ...
    # ── LEVEL 3: Puzzles — switches, portões, espinhos alternados ─
        ...
        switches.append(Switch(600, 588))
        gates.append(Gate(1100, 340, 45, 260))

        enemies.append(Enemy(200, 580, 80, hp(3)))
        enemies.append(FlyingEnemy(450, 500, hp(2), float_height=440))
        checkpoints.append(Checkpoint(480, 576))
        ...
        platforms.append(Platform(2150, 600, 400, 40, 0))

        enemies.append(ShootingEnemy(1300, 520, 80, hp(3)))
        enemies.append(Enemy(1450, 520, 60, hp(4)))
        enemies.append(ShootingEnemy(1700, 500, 60, hp(3)))
        enemies.append(FlyingEnemy(1950, 430, hp(2), float_height=380))
        enemies.append(Enemy(2200, 560, 80, hp(4)))

        orbs.append(HealthOrb(1800, 470))
        checkpoints.append(Checkpoint(1550, 516))

        # Zona 3: Moving platforms + combinação
        m_plats.append(MovingPlatform(2650, 540, 140, 22, 0, -160))
        platforms.append(Platform(2850, 580, 320, 40, 0))
        m_plats.append(MovingPlatform(3230, 560, 130, 22, 180, 0))
        platforms.append(Platform(3460, 560, 300, 30, 2))
        platforms.append(Platform(3820, 600, 540, 40, 0))

        enemies.append(Enemy(2700, 500, 80, hp(4)))
        enemies.append(ShootingEnemy(2880, 540, 80, hp(3)))
        enemies.append(FlyingEnemy(3100, 430, hp(3), float_height=370))
        enemies.append(Enemy(3280, 520, 70, hp(4)))
        enemies.append(Enemy(3500, 520, 80, hp(4)))
        enemies.append(ShootingEnemy(3600, 520, 70, hp(3)))

        # Zona 4: Expansão v2.0
        m_plats.append(MovingPlatform(4380, 560, 140, 22, 0, -180))
        platforms.append(Platform(4550, 540, 250, 30, 0))
        enemies.append(Enemy(4600, 500, 80, hp(5)))
        enemies.append(FlyingEnemy(4650, 420, hp(3), float_height=350))

        orbs.append(HealthOrb(3500, 490))
        checkpoints.append(Checkpoint(3570, 536))
    ...
    # ── LEVEL 4: A Ascensão — desafio de pulo vertical ───────
        ...
        # Zona 4: Expansão v2.0
        platforms.append(Platform(4100, 480, 300, 30, 2))
        m_plats.append(MovingPlatform(4500, 460, 160, 22, 100, -150))
        platforms.append(Platform(4800, 530, 350, 40, 0))
        enemies.append(Enemy(4150, 440, 80, hp(5)))
        enemies.append(FlyingEnemy(4300, 360, hp(3), float_height=300))
        enemies.append(ShootingEnemy(4850, 490, 100, hp(4)))
    ...
    # ── LEVEL 5: O Boss Final — arena corrigida ───────────────
        ...
        # O portão que abre após o boss é colocado em ARENA_X2
