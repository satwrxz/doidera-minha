...
class Enemy:
    ...
    def update(self, platforms, player_rect):
        ...
        # Borda de plataforma: NUNCA pula se patrol, tenta pular se chase/attack
...
class HUD:
    ...
    def draw_start_screen(self,surf):
        ...
        y_off = int(math.sin(pygame.time.get_ticks() * 0.002) * 10)
        title=ft.render("SHADOWCROFT",True,C_UI_TITLE)
        draw_rect_alpha(surf,C_CHK_GLOW,
            (SCREEN_W//2-title.get_width()//2-12,SCREEN_H//2-68+y_off,
             title.get_width()+24,72),gl//4)
        surf.blit(title,(SCREEN_W//2-title.get_width()//2,SCREEN_H//2-62+y_off))
...
def build_level(level_id=1, difficulty=1.0):
    ...
    if level_id == 1:
        ...
        # Expansão
        platforms.append(Platform(3150, 580, 250, 30))
        platforms.append(Platform(3580, 540, 200, 30))
        enemies.append(Enemy(3200, 540, 80, hp(4)))
    ...
    # ── LEVEL 2: Plataformas — corrigido, sem espinhos duplos ─
        ...
        # Expansão
        platforms.append(Platform(3550, 560, 250, 30))
        platforms.append(Platform(3950, 540, 250, 30))
        enemies.append(ShootingEnemy(3600, 520, 80, hp(3)))
    ...
    # ── LEVEL 3: Puzzles — switches, portões, espinhos alternados ─
        ...
        # Expansão
        platforms.append(Platform(3750, 580, 300, 30))
        platforms.append(Platform(4250, 540, 300, 30))
    ...
    # ── LEVEL 4: A Ascensão — desafio de pulo vertical ───────
        ...
        # Expansão
        platforms.append(Platform(4150, 520, 300, 30))
        platforms.append(Platform(4650, 480, 300, 30))
        enemies.append(FlyingEnemy(4200, 400, hp(3), float_height=320))
